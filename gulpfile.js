...
const COPIED_ASSETS_DIRECTORIES = ['fonts', 'icons/socials']; // you may add here a list of asset directories that should be copied 1-to-1 to the asset distribution folders
